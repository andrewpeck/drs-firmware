...
% START: ADDRESS_TABLE :: DO NOT EDIT
    ...
    DTAP\_HIGH\_CNTS & \texttt{0x1} & \texttt{[20:0]} & r & \texttt{} & Number of 33MHz clocks counted while DTAP was high. Should be equal to 33 Million (0x1f78a40) for 1.024 GHz sampling rate. Please see manual  \\\hline
    DTAP\_LOW\_CNTS & \texttt{0x2} & \texttt{[20:0]} & r & \texttt{} & Number of 33MHz clocks counted while DTAP was low. Should be equal to 33 Million (0x1f78a40) for 1.024 GHz sampling rate. Please see manual  \\\hline
    \end{tabularx}
    \vspace{5mm}
